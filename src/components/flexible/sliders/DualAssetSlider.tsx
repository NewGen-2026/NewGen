...
const DualAssetSlider = (props) => {
	...
	return (
		<div className="flex flex-col justify-between gap-8 md:h-[480px] md:flex-row">
			<TransitionSlider intervalDuration={4000} className="relative max-w-[907px] flex-1 overflow-hidden bg-stone/20">
			...
			<TransitionSlider startDelay={500} intervalDuration={7000} className="relative flex-1 bg-stone/20 md:max-w-[437px]">
