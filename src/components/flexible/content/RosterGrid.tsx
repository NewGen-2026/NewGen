	...
	return (
		<div className=" flex flex-wrap gap-2 sm:gap-4 md:gap-8 ">
			{roster?.map((creator, i) => (
				<div
					key={`creator${i}`}
					className={`${i === 6 ? "flex-[1_1_45%] lg:flex-[1_1_907px]" : "flex-[1_1_45%] lg:flex-[1_1_30%] 2xl:flex-[1_1_437px]"}  bg-energy`}
				>
...
const GridLink = () => {
	...
	return (
		<Link
			...
			className="flex flex-1 items-center justify-center bg-energy p-5 py-20 text-center text-boost transition-colors duration-200 hover:bg-boost hover:text-energy lg:aspect-[437/580] lg:flex-[1_1_437px]"
		>
